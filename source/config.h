...
#define MSG_LINE      0  /* message line location */
#define MAX_SAVE_MSG  22 /* number of messages to save in a buffer */
...
#ifdef CTRL
   #warning Undefining previously-defined CTRL macro
#endif
#undef CTRL
#define CTRL(x)      (x & 0x1F)
#define MORIA_DELETE 0x7f
#define ESCAPE       0x1b /* ESCAPE character -CJS- */
